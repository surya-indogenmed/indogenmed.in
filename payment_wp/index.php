<?php
   ...
   /* $sql = "SELECT
	p.id as ID,
    MAX(a.first_name) AS payment_firstname,
    MAX(a.last_name) AS payment_lastname,
    MAX(a.address_1) AS payment_address_1,
    MAX(a.address_2) AS payment_address_2,
    MAX(a.city) AS payment_city,
    MAX(a.postcode) AS payment_postcode,
    MAX(a.country) AS payment_country,
    MAX(a.email) AS email,
    MAX(a.phone) AS telephone,
    MAX(a.state) AS payment_zone,
...
INNER JOIN
    ...
    if (!$result) {
        // If there's an error in the SQL query, print it
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            $total = $row['total'];
            $currency_total = 1; //$row['currency_value'];
 ...
 */ ?>                           
            ...
            <script>
                ...
                function stripe(orderid) {
                    ...
                    window.location =  domain_link + "st/main_wp.php?order_id="+orderid;
                }
